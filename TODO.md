...
- [ ] تغییر فرمت فایل از JSON Lines فعلی به یک آرایهٔ JSON واقعی (`[ {...}, {...} ]`) مطابق سند.
- [ ] مدیریت خطاهای فایل: عدم وجود فایل، JSON خراب (corrupt)، مشکلات دسترسی — با پیام/لاگ مناسب به‌جای crash یا سکوت کامل.
- [ ] اطمینان از این‌که ذخیره بعد از هر تغییر مهم (و/یا هنگام خروج) انجام می‌شود.
