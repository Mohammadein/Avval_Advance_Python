...
- [ ] نوشتن تست‌های واحد برای منطق اصلی، **مستقل از CLI/Web UI**:
  - [ ] افزودن یادداشت (و تخصیص صحیح ID یکتا، حتی بعد از حذف‌ها)
  - [ ] جستجوی یادداشت بر اساس ID (پیدا شدن / پیدا نشدن)
  - [ ] به‌روزرسانی یادداشت (تغییر `last_modified_date`، حفظ `creation_date`)
  - [ ] حذف یادداشت
  - [ ] ذخیره/بارگذاری از JSON (شامل حالت فایل خراب/ناموجود)
- [ ] اجرا با `python -m pytest --cov` بدون خطا و coverage بالای ۸۰٪.
